...
const socketConnection = require("./controllers/Chat");
const testSocketConnection = require("./controllers/TestChat")
...
testSocketConnection(socketIo) // call the testSocketConnection function
